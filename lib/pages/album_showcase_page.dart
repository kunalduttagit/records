...
class AlbumShowcasePage extends StatefulWidget {
  final Album album;
  final SpotifyService spotifyService;
  const AlbumShowcasePage({
    super.key,
    required this.album,
  ...
  @override
  State<AlbumShowcasePage> createState() => _AlbumShowcasePageState();
}

class _AlbumShowcasePageState extends State<AlbumShowcasePage> {
          ...
          children: [
                ...
                Center(
                    child: Column(
                      children: [
                        ...
                        Text("Album by ${widget.album.albumArtistName} • ${widget.album.releaseDate.substring(0,4)}", style: TextStyle(color: Colors.grey[800]))
                      ],
                    )
                  ),
              ],
                  ...
                  children: _tracks.mapIndexed((track, index) => 
                    InkWell(
                      onTap: () async {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) => MusicPlayer(track: tempTrack, currSongIndex: index, isAlbum: true, spotifyService: widget.spotifyService, albumTrackList: _tracks,album: widget.album)));
                      },
                      child: Padding(
            ...
            Center(
              child: Padding(
                ...
                child: Text("${widget.album.albumTotalTracks} songs • ${getTotalDuration(_tracks)}",
